...
public class HorizontalNumberPicker extends LinearLayout {
	...
	private final int[] SELECTOR_INDICES_MEDIUM = new int[] {
			...
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE };
	private final int[] SELECTOR_INDICES_SMALL = new int[] { Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			...
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, };
	private final int[] SELECTOR_INDICES_LARGE = new int[] { Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
			Integer.MIN_VALUE, };
	...
	/**
	 * Sets the values to be displayed.If autoCalMinMax passed true, will
	 * calculate and set min value and max value.
	 * 
	 * @param displayedValues
	 *            The displayed values.
	 * @param autoCalMinMax
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < selectorIndices.length; i++) {
			...
			if (i - mSelectorMiddleItemIndex > 0) {
				...
				mSelectorWheelPaint.setAlpha((2 * mSelectorMiddleItemIndex - i)
						* SELECTOR_TEXT_ALPHA_TRANSPARENT_NONE
						/ mSelectorMiddleItemIndex);
			} else if (i - mSelectorMiddleItemIndex < 0) {
				mSelectorWheelPaint.setColor(Color.WHITE);
				mSelectorWheelPaint.setAlpha(i
						* SELECTOR_TEXT_ALPHA_TRANSPARENT_NONE
						/ mSelectorMiddleItemIndex);
			} else {
				mSelectorWheelPaint.setColor(Color.RED);
				mSelectorWheelPaint
						.setAlpha(SELECTOR_TEXT_ALPHA_TRANSPARENT_NONE);
			}
			...
			canvas.drawRect(x, y + fGapBetweenNumAndScale, x + fWidthOfScale, y
					+ fGapBetweenNumAndScale + fScaleLength,
					mSelectorWheelPaint);
